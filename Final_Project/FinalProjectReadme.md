...
| Documentation: ProjectReadme.md File           | 25 pts   |            |    
| Working Code submitted to whitgit              | 30 pts   |            |
| Final Presentation & Analysis                  | 25 pts   |            | 
| Final Reflection & Professionalism & Teamwork  | 10 pts   |            |
| Total                                          | 100 pts  |            |

### General Requirements
Overall this final project will contribute 20% of your overall grade for this class.  
* As a group you must choose and implement advanced algorithm(s) and apply it(them) to a real world problem.
...
### Above and Beyond Projects for Bonus Points (Not Required)
* Make significant improvements to the __computational efficiency__ of an existing opensource project. This would be amazing and give you some real street "cred" if your improvements are adopted and integrated in the project. Be prepared to do a *lot* of extra work if you go this route.
* Develop and deliver a working algorithm/project for an external client. NOTE: Do not approach Whitworth "clients"  without first talking to me and letting me verify if the "client" is willing to be a "client".
* Propose your own "Above and Beyond" category and if I approve it I may give you some extra points!

### Example Ideas
Here are some ideas.

* Non Profit Delivery Applications: Use a map interface to select delivery points. Compute the optimal route to those points.
* Other application for a client of your choosing that requires an efficient optimization algorithm.
* Optimization algorithms for routing etc. 
...
Please push your Paragraph Proposal to this Whitgit Folder for your project group.

I highly encourage each group to make a short project proposal to your instructor before you proceed. You don't want to be that group which at presentation time finds that their project was not sufficient!  Take the time to communicate with your instructor and determine if the level of difficulty is acceptable. Write up the project paragraph. Discuss this with your instructor before or on the due date. This paragraph can eventually become a part of your projects ProjectReadme.md file.

### Deliverable #2: Final Project Code and ProjectReadme.md Documentation File Due at the Final in the Groups Assigned Whitgit Repository
Your group will submit a ProjectReadme.md file along with your with all the code for your project to your shared Whitgit final project repository. This ProjectReadme.md file will contain
...
* A detailed complexity anlysis where you compare worst case run time to empirical run time results.
...
* You must present a summary of the __worst case__ and empirical __algorithm analysis__ (that you completed for the ProjectReadme.md documentation) of your algorithm and compare these results. For the empirical analysis make sure to use the period doubling method as described in class.

### Deliverable #4: Individual Project Reflection (Microsoft Forms Link Will be Provided)
Each group (at the start of the project) will make a group contract, which, will be evaluated by a Microsoft Forms link provided at the end of the semester. The questions on the form will be reflective in nature and likely very similar to the questions shown here:
